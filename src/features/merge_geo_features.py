...
def main() -> None:
    ...
    out_parquet = PROCESSED_DIR / "model_data_ena2024_plus_geo.parquet"
    merged.to_parquet(out_parquet, index=False)

    out_csv = PROCESSED_DIR / "model_data_ena2024_plus_geo.csv"
    ...
    coverage_csv = OUTPUT_TABLES / "06_geo_feature_coverage.csv"
    coverage_md = OUTPUT_TABLES / "06_geo_feature_coverage.md"
